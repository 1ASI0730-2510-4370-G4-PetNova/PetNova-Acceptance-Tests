Feature: Gestión de Perfiles de Usuarios
  ...
  Scenario: El administrador modifica los datos de un usuario
    ...
    Then el sistema debe guardar los cambios realizados y mostrar un mensaje que confirme la actualización exitosa
  ...
  Scenario: El administrador inhabilita una cuenta de usuario
    ...
    Then el sistema debe marcar la cuenta como "inactiva", impidiendo que el usuario acceda hasta que sea reactivado
  ...
  Scenario: El administrador elimina un usuario del sistema
    ...
    Then el sistema debe borrar de forma definitiva dicho perfil y toda su información relacionada, mostrando previamente una advertencia de confirmación