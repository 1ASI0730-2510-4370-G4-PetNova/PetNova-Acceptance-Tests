Feature: Notificación de Citas Veterinarias
  Como usuario, quiero recibir notificaciones sobre mis citas veterinarias para recordar cuándo debo llevar a mi mascota al veterinario.

  Scenario: El usuario recibe una notificación antes de la cita
    Given que el usuario tiene una cita veterinaria agendada
  ...
  Scenario: El usuario desactiva las notificaciones de citas
    ...
    When desactiva la opción de notificaciones de citas veterinarias
